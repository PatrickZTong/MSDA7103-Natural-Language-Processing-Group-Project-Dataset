...
drop tokens shorter than mean/3 or longer than 3× mean (mean = average character
length after tokenization) → lemmatize (NLTK).

This version is almost identical to ``c_data_preprocessing.py`` except it does
